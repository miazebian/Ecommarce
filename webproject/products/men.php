      ...
      if (isset($_POST['submit'])) {
        if (!empty($_POST['filtering'])) {
          ...
          if ($selected == "lowToHigh") {
            $query = "SELECT * FROM product WHERE category='men' ORDER BY `price` ASC;";
          }
          if ($selected == "hightToLow") {
            $query = "SELECT * FROM product WHERE category='men' ORDER BY `price` DESC;";
          }
          if($selected == "AZ"){
            $query = "SELECT * FROM product WHERE category='men' ORDER BY `name` ASC;";
          }
          if($selected == "ZA"){
            $query = "SELECT * FROM product WHERE category='men' ORDER BY `name` DESC;";
          }
        }
      }
 else{
